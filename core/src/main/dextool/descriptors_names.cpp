...
std::string DotToDescriptor(const char *class_name) {
    ...
    descriptor.replace(descriptor.begin(), descriptor.end(), '.', '/');
...
static const uint32_t DEX_MEMBER_VALID_LOW_ASCII[4] = {
 ...
 */
inline static bool IsValidPartOfMemberNameUtf8(const char **pUtf8Ptr) {
